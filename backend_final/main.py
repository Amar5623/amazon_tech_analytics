...
app.include_router(brand_router.router, prefix="/api/brand", tags=["brand"])  # Keep the prefix here
app.include_router(image_gallery.router, prefix="/api/image-gallery", tags=["image gallery"])
app.include_router(spec_insight.router, prefix="/api/spec-insight", tags=["specification insight"])
